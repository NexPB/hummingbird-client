...
export default Route.extend(Pagination, {
  ...
  model(params) {
    return {
      taskInstance: get(this, 'getLibraryEntriesTask').perform(params),
      paginatedRecords: []
    };
  },
   ...
   * and media type. This is invoked by the model hook.
   */
  getLibraryEntriesTask: task(function* (params) {
   ...
   *
   * @param {String} Sorting Value
   */
  _getSortingKey(sort) {
    // get the query param value for `media`
